...
-   Our LDA notebook uses the Gensim LDA model which establishes document similarity. You can see the Gensim documentation [here](https://radimrehurek.com/gensim/auto_examples/tutorials/run_lda.html).
